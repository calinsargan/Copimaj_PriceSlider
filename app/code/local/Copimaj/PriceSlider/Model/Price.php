 ...
 */
class Copimaj_PriceSlider_Model_Price extends Mage_Catalog_Model_Layer_Filter_Abstract
{
    /**
    ...
    public function apply(Zend_Controller_Request_Abstract $request, $filterBlock)
    {
        ...
        $From= $request->getParam('from'); //get the from=x from url
        $To= $request->getParam('to');//get the to=y from url
         
        if (!$filter&&(!isset($From)||!isset($To))) {
            return $this;
        }
