 ...
 */
class Copimaj_PriceSlider_Model_Item extends Varien_Object
{
    /**
     * Get filter instance
     *
    ...
    public function getRemoveUrl()
    {
        ...
        $currentUrl = $this->getUrl($urlPart);
         if($this->getFilter()->getRequestVar()=="price"){ //check if the concerned filter is price
            if(strpos($currentUrl,"from")||strpos($currentUrl,"to")) //If filter was custom
            {
                //New method
                $query['from']=null; //remove the from and to
                $query['to']=null;
                $query['price']=null;
                $params['_query']       = $query;
